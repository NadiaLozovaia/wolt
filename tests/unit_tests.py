...
def test_get_rush_hour_multiplier():
    ...
    assert (
        get_rush_hour_multiplier(datetime.fromisoformat("2024-01-19T15:00:00Z")) == 1.2
    )
    assert (
        get_rush_hour_multiplier(datetime.fromisoformat("2024-01-19T15:00:01Z")) == 1.2
    )
    assert (
        get_rush_hour_multiplier(datetime.fromisoformat("2024-01-19T18:59:59Z")) == 1.2
    )
...
def test_get_delivery_fee():
    ...
    assert (
        get_delivery_fee(1000, 1000, 4, datetime.fromisoformat("2024-01-19T13:00:00Z"))
        == 200
    )
    assert (
        get_delivery_fee(1000, 1001, 4, datetime.fromisoformat("2024-01-19T13:00:00Z"))
        == 300
    )
    assert (
        get_delivery_fee(
